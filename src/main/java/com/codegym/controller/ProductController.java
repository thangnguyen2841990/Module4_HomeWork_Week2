...
public class ProductController {
    ...
    @GetMapping
    private ModelAndView showAllProducts(String name, Optional<Integer> page){
        ...
        if (name == null){
            ...
            Page<Product> products = this.productService.findByName(name,pageable);
            ModelAndView modelAndView = new ModelAndView("/product/list");
            modelAndView.addObject("products",products);
    ...
    @GetMapping("/search")
    private ModelAndView findProductByCategory(Long categoryId, Pageable pageable){
